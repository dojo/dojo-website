...
<body class="claro">
	...
	?>
	<script>
		// We are going to create a global object to "hold" our different functions
		var demo = {};
		require([
			"dojo/date",
			"dojo/dom",
			...
			demo.daysSince = function(fromDate, target){
				// summary:
			...
			on(dom.byId("dojoQuery"), "click", demo.topLinks);
			on(dom.byId("dojoDate"), "click", function(){
				demo.daysSince("January 1, 2000 00:00:00", "outDate");
			});
		});
	</script>
</body>
