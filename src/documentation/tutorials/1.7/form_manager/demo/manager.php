				...
				<form data-dojo-type="dojox.form.Manager" id="form">
					<fieldset data-dojo-attach-point="part1">
						...
						<div>
							...
							&nbsp;
							<input type="radio" id="e022" name="e02" value="e02-2" checked="checked" observer="showValues">
						...
						<div>
							...
							<textarea id="e07" name="e07"
								rows="3" cols="15" style="width: 15em;" observer="showValues">e07</textarea>
						</div>
						<div>
					...
					<fieldset data-dojo-attach-point="part2">
						...
						<div>
							<input type="checkbox" data-dojo-type="dijit.form.CheckBox" id="w01" name="w01" value="w01" observer="showValues">
							&nbsp;<label for="w01">w01 input/checkbox dijit.form.CheckBox</label>
						</div>
						<div>
							<input type="radio" data-dojo-type="dijit.form.RadioButton" id="w021" name="w02" value="w02-1" observer="showValues">
							&nbsp;<label for="w021">w02-1 input/radio dijit.form.RadioButton</label>
							&nbsp;
							<input type="radio" data-dojo-type="dijit.form.RadioButton" id="w022" name="w02" value="w02-2" checked="checked" observer="showValues, logRadio">
							&nbsp;<label for="w022">w02-2 input/radio dijit.form.RadioButton</label>
						</div>
						<div>
							<input type="text" data-dojo-type="dijit.form.TextBox" id="w03" name="w03" value="w03" data-dojo-props="intermediateChanges:true" observer="showValues">
							&nbsp;<label for="w03">w03 input/text dijit.form.TextBox with intermediateChanges set to true</label>
						</div>
						<div>
							<input type="password" data-dojo-type="dijit.form.TextBox" id="w04" name="w04" value="w04" data-dojo-props="intermediateChanges:false" observer="showValues">
							&nbsp;<label for="w04">w04 input/password dijit.form.TextBox with intermediateChanges set to false</label>
						</div>
						<div>
							<select data-dojo-type="dijit.form.Select" id="w06" name="w06" observer="showValues">
						...
						<div>
							...
							<textarea data-dojo-type="dijit.form.SimpleTextarea" id="w07" name="w07" observer="showValues"
								rows="3" cols="15" style="width: 15em;" data-dojo-props="intermediateChanges:true">w07</textarea>
						</div>
						<div>
							<button data-dojo-type="dijit.form.Button" name="w08" observer="showValues">w08 button</button>&nbsp;
							<button type="button" data-dojo-type="dijit.form.Button" name="w09" observer="showValues">w09 type=button</button>&nbsp;
							<button type="reset" data-dojo-type="dijit.form.Button" name="w10" observer="showValues">w10 type=reset</button>&nbsp;
							<button type="submit" data-dojo-type="dijit.form.Button" name="w11" observer="showValues">w11 type=submit</button>
						</div>
					</fieldset>
