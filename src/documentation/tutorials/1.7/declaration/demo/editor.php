...
<html lang="en">
	...
	<body class="claro">
		...
		<div data-dojo-type="dijit.Declaration" data-dojo-props="widgetClass:'ComplexWidget', defaults:{ title:'A Complex Widget' }">
			...
			<script type="dojo/connect" data-dojo-event="startup">
				...
				if(this.data){
					...
					this.store = new dojo.data.ItemFileReadStore({ data: this.data });
		...
		<script>
			...
			require(["dojo/parser", "dojo/data/ItemFileReadStore", "dijit/layout/BorderContainer", "dijit/layout/ContentPane", "dojox/grid/DataGrid", "dijit/Editor", "dijit/Declaration", "dojo/domReady!"], function(parser) {
				parser.parse();
			});
