...
<html lang="en">
	<head>
		...
		<?php Utils::printLinkStyleTags(array('dojox/grid/resources/Grid.css','dojox/grid/resources/claroGrid.css')) ?>
	...
	<body class="claro">
		...
		<script>
			require(["dojo/store/Memory",
				...
				"dojox/math/round",
				"dojo/domReady!"], 
				function(Memory, ObjectStore, DataGrid, mathRound){

				dojo.xhrGet({url: "hof-batting.json", handleAs: "json", load: function(data) {
