...
<html lang="en">
	...
	<body class="claro">
		...
		<script>
			require(["demo/app-step5", "dijit/layout/BorderContainer", "dijit/layout/TabContainer", "dijit/layout/ContentPane", "dojox/data/FlickrRestStore", "dojo/domReady!"], function(demoApp) {
				demoApp.init();
			});
		</script>
	</body>
