...
<html>
	...
	<body class="claro">
		...
		<script>
			...
			require(["dijit/form/RadioButton", "dijit/form/ToggleButton", "dojo/on", "dijit/registry", "dojo/parser", "dojo/ready"], function(RadioButton, ToggleButton, on, registry, parser, ready) {
