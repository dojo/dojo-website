...
<html lang="en">
	...
	<body class="claro">
		...
		<script>
			...
			require(["dijit/form/HorizontalSlider", "dijit/form/VerticalSlider", "dijit/form/Button", "dojo/aspect", "dijit/registry", "dojo/parser", "dojo/ready"],
					function(HorizontalSlider, VerticalSlider, Button, aspect, registry, parser, ready) {
