...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../../../../../resources/style/demo.css" media="screen">
			...
			Utils::printClaroCss();
                        Utils::printDojoScript("async: true, parseOnLoad: false, paths: { demo: location.pathname.substring(0, location.pathname.lastIndexOf('/tests')), doh: '/js/dojo/1.8/util/doh', }, authorsUrl: '../../resources/authors.json', authorName: 'Sam Foster'");
		?>
		<script>
			require(["doh/runner",
				"demo/authorBar",
