...
<html lang="en">
	...
	<body class="claro">
		...
		?>
		<script>
			require(["dojo/parser", "dojo/ready", "dijit/layout/BorderContainer", "dijit/layout/ContentPane", "dijit/layout/StackContainer",
					"dijit/layout/StackController"], function(parser, ready){
				ready(function(){
					parser.parse();
				});
			});
