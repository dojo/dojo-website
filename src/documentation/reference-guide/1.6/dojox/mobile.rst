...
* A series of lightweight widgets to mimic basic mobile device native interfaces, including:
  ...
  * :ref:`View <dojox/mobile/View>`- A single 'view'
  * :ref:`ScrollableView <dojox/mobile/ScrollableView>`- A view with touch scroll
  * :ref:`FlippableView <dojox/mobile/FlippableView>`- A view that can be swiped horizontally
