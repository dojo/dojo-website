	...
	function(dojo, doh, dojoColors, text, strippedText) {
		doh.register("test.amd.backCompat", [
			...
			function i18nPlugin(t){
				t.assertEqual(dojoColors, dojo.requireLocalization("dojo", "colors", null, "ROOT,ar,ca,cs,da,de,el,es,fi,fr,he,hu,it,ja,kk,ko,nb,nl,pl,pt,pt-pt,ro,ru,sk,sl,sv,th,tr,zh,zh-tw"));
			},
