if(!dojo._hasResource["dojo.tests.store.DataStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojo.tests.store.DataStore"] = true;
