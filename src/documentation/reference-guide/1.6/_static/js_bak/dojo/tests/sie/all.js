if(!dojo._hasResource["tests.sie.all"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["tests.sie.all"] = true;
dojo.provide("tests.sie.all");
