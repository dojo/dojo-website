...
if(!dojo._hasResource["docs.doctools"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["docs.doctools"] = true;
dojo.provide("docs.doctools");
...
if(!dojo._hasResource["docs.searchtools"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["docs.searchtools"] = true;
dojo.provide("docs.searchtools");
...
if(!dojo._hasResource["docs.doclayer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["docs.doclayer"] = true;
dojo.provide("docs.doclayer");
// these are the Sphinx specific requires()


// also include CodeGlass and plugins:

dojo.ready(function(){ 
//	CodeGlass.plugins.dojo.version.prototype.baseUrls = [];
	dojo.parser.parse(); 
});
