if(!dojo._hasResource["dojox.secure.tests.fromJson"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.secure.tests.fromJson"] = true;
