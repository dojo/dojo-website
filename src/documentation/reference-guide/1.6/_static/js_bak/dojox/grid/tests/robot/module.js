if(!dojo._hasResource["dojox.grid.tests.robot.module"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.grid.tests.robot.module"] = true;
