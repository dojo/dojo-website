if(!dojo._hasResource["dojox.encoding.tests.crypto.RSA"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.encoding.tests.crypto.RSA"] = true;
