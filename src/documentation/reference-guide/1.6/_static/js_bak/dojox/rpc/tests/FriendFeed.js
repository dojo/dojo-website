if(!dojo._hasResource['dojox.rpc.tests.FriendFeed']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['dojox.rpc.tests.FriendFeed'] = true;
