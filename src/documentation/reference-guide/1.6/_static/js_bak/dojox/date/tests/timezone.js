if(!dojo._hasResource["dojox.date.tests.timezone"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.date.tests.timezone"] = true;
