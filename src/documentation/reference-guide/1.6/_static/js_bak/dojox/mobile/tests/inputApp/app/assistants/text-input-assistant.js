if(!dojo._hasResource["TextInputAssistant"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["TextInputAssistant"] = true;
