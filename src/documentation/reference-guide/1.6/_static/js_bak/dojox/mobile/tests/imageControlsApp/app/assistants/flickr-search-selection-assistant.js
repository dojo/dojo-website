if(!dojo._hasResource["FlickrSearchSelectionAssistant"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["FlickrSearchSelectionAssistant"] = true;
