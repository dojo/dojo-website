define("dojox/html/styles", ["dojo/_base/lang", "dojo/_base/array", "dojo/_base/window", "dojo/_base/sniff"], 
	...
	dh.removeCssRule = function(/*String*/selector, /*String*/declaration, /*String*/styleSheetName){
		...
		if(index===-1){
			 0 && console.warn("The css rule was not found and could not be removed.");
			return false;
		}
			...
			if(has("ie")){
				...
				try {
					...
					// issue a warning that stylesheet couldn't be loaded, but continue
					 0 && console.warn("Reading css rules from stylesheet "+s.href+" is forbidden due to same-origin policy. See http://www.w3.org/TR/CSP/#cascading-style-sheet-css-parsing",s);
				}
