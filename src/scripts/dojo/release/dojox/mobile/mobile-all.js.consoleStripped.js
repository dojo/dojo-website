define("dojox/mobile/mobile-all", [
	...
	//		dojox/mobile/mobile-all
	 ...
	 0 && console.warn("dojox/mobile/mobile-all may include much more code than your application actually requires. We strongly recommend that you use a custom build.");
