define("dojox/mobile/ScreenSizeAware", [
	...
	var cls = declare("dojox.mobile.ScreenSizeAware", null, {
		...
		init: function(){
			...
			if(!this.splitter){
				 0 && console.error("Splitter not found.");
				return;
			}
			...
			if(!this.leftPane){
				 0 && console.error("Left pane not found.");
				return;
			}
			...
			if(!this.rightPane){
				 0 && console.error("Right pane not found.");
				return;
			}
			...
			if(!this.leftView){
				 0 && console.error("Left view not found.");
				return;
			}
			...
			if(!this.leftList){
				 0 && console.error("Left list not found.");
				return;
			}
		},
